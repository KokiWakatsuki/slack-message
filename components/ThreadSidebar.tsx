...
export function ThreadSidebar({ rootMessage, channelId }: ThreadSidebarProps) {
    ...
    return (
        <div className="w-full flex flex-col border-l border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 h-full shadow-xl z-20">
            ...
            {/* Mobile Header */}
            <div className="md:hidden flex items-center px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                <button
                    onClick={closeThread}
                    className="mr-3 p-2 -ml-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400"
                >
